...
import { MessageSquareCode, Mail, Lock, User, Phone, ArrowLeft, Eye, EyeOff } from 'lucide-react';
import { useApp } from '../../context/AppContext';

export default function Register() {
  const { registerUser, navigate, showToast } = useApp();
    ...
    <div className="auth-container" style={{ padding: '40px 24px' }}>
      <div className="auth-card" style={{ maxWidth: '480px' }}>
        ...
        <div className="auth-header">
          ...
          <p className="auth-subtitle">Join TalkWave chat application today</p>
        </div>
